                        ...
                        <div class="card-body">
                            <form action="#" method="POST" name="login">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="password" class="form-control" name="password" minlength="5" maxlength="20" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="password_confirm" class="form-control" name="password_confirm"  minlength="5" maxlength="20" required>
...
if (isset($_POST["reset"])) {
    ...
    if ($Email && $psw === $psw_confirm) {
        $passwordenc = md5($psw);
        // $new_pass = $hash;
        mysqli_query($conn, "UPDATE tb_user SET password='$passwordenc' WHERE email='$Email'");
