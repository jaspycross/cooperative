                ...
                <div class="card my-5">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="true" href="recover_psw2.php">พี่เลี้ยงนักศึกษาสหกิจ</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="" method="POST" name="recover_psw">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="email" id="email_address" class="form-control" name="email_m" required autofocus>
                                </div>
                            </div>
...
?>
        ...
        echo "<script>
            ...
            Swal.fire( {
                ...
                window.location.href = 'recover_psw2.php';
            });
        });
        </script>";
        ?>
    <?php
    } else if ($fetch["userlevel_m"] != 3) {
    ?>
        <?php
        echo "<script>
            $(document).ready(function() {
        ...
        $mail->Body = "
            ...
            http://localhost/project1/reset_psw2.php";
