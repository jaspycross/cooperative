                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="password" class="form-control" name="password_tm" minlength="5" maxlength="20" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" id="password_confirm" class="form-control" name="password_confirm_tm"  minlength="5" maxlength="20" required>
...
if (isset($_POST["reset"])) {
    $psw = $_POST["password_tm"];
    $psw_confirm = $_POST["password_confirm_tm"];

    $token = $_SESSION['token'];
    $Email = $_SESSION['email_tm'];
    ...
    if ($Email && $psw === $psw_confirm) {
        $passwordenc = md5($psw);
        // $new_pass = $hash;
        mysqli_query($conn, "UPDATE tb_teacher_admin SET password_tm = '$passwordenc' WHERE email_tm = '$Email'");
?>
        <?php
        echo "<script>
