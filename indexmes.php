    ...
    <div class="container text-center ">
        <div class="row">
            ...
            <div class="col-12 col-md-9 col-sm-12">
                                ...
                                <div class="container text-center">
                                    <div class="row row-cols-5">
                                        <div class="col-12 col-sm-4 mb-2">
                                            <a class="btn btn btn-primary w-100" href="indexmes.php" role="button"><i class="fa-solid fa-users"></i>&nbsp;ทั้งหมด</a>
                                        </div>
                                        <div class="col-12 col-sm-4 mb-2">
                ...
                <!-- loop โฟสต์ข้อความ -->
                <?php
                $result = mysqli_query($conn, "SELECT * FROM `tb_postmessage` ORDER BY `tb_postmessage`.`id` DESC");
