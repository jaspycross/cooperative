...
if ($_SESSION['userlevel_tm'] != '5' || !$_SESSION['userlevel_tm']) {
  ...
  $(document).ready(function() {
    ...
    if (isset($_POST['btncom'])) {
        ...
        $sql =  "INSERT INTO  tb_comment (id_post, id_recomment_post, recomment_post, text)
                    VALUES ('$id_post', '$id_recomment_post', '$recomment_post', '$text')";
        ...
        <div class="container text-center ">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-sm-12">
                                ...
                                <div class="card-body">
                                    <div class="container text-center">
                                        <div class="row row-cols-5">
                                            ...
                                            <div class="col-12 col-sm-4 mb-2">
                                                <a class="btn btn btn-primary w-100" href="index2.php" role="button"><i class="fa-solid fa-user"></i>&nbsp;อาจารย์ที่ปรึกษา</a>
                                            </div>
                                            <div class="col-12 col-sm-4 mb-2">
                                            ...
                                            <div class="col-12 col-sm-4 mb-2">
                                                <a class="btn btn btn-outline-primary w-100" href="index4.php" role="button"><i class="fa-solid fa-user"></i>&nbsp;อาจารย์ประสานงาน</a>
                                            </div>
                                            <div class="col-12 col-sm-4 mb-2">
                                                <a class="btn btn btn-outline-primary w-100" href="index5.php" role="button"><i class="fa-solid fa-user-shield"></i>&nbsp;<i class="fa-solid fa-user"></i>&nbsp;ผู้ดูแลระบบ</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- loop โฟสต์ข้อความ -->
                    <?php
                    $result = mysqli_query($conn, "SELECT * FROM `tb_postmessage` WHERE `headding` LIKE '2' ORDER BY `id` DESC");
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            ...
                                            <a href="delmes2.php?delmes2=<?php echo $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')" title="ลบข้อมูล">
