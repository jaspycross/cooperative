                                ...
                                <div class="card-body">
                                    <div class="container text-center">
                                        <div class="row row-cols-5">
                                            ...
                                            <div class="col-12 col-sm-4 mb-2">
                                                <a class="btn btn btn-primary w-100" href="index5.php" role="button"><i class="fa-solid fa-user-shield"></i>&nbsp;ผู้ดูแลระบบ</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-header ">
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable modal-md modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer" style="background-color: #ffd966;">
                                                            <button type="submit" class="btn btn-success" name="btnupdate">บันทึก</button>
                                            ...
                                            <a href="delmes5.php?delmes5=<?php echo $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')" title="ลบข้อมูล">
