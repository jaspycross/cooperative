...
if ($_SESSION['userlevel_tm'] != '5' || !$_SESSION['userlevel_tm']) {
  ...
  $(document).ready(function() {
    ...
    if (isset($_POST['submit'])) {
        ...
        $user_check = "SELECT * FROM tb_teacher_admin WHERE email_tm = '$email_tm' LIMIT 1";
        ...
        if ($user) {
            ...
            $query  =   "INSERT INTO tb_teacher_admin (imge, prefix_tm, firstname_tm, lastname_tm, gender_tm, faculty_tm, branch_tm, status_tm, userlevel_tm, email_tm, password_tm, onoof_tm)
                        VALUE ('$newfilename', '$prefix_tm', '$firstname_tm', '$lastname_tm', '$gender_tm', '$faculty_tm', '$branch_tm', '$status_tm', '$userlevel_tm', '$email_tm', '$passwordenc','$onoof_tm')";
                            ...
                            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                <div class="accordion-body">
                                    <ul class="list-group list-group-flush h6">
                                        ...
                                        <li class="list-group-item"><a href="form_register2.php" class="text-decoration-none">เพิ่มข้อมูลอาจารย์ที่ปรึกษาหรืออาจารย์ประสานงาน</a></li>
                    ...
                    <div class="mt-3 mt-md-3 mt-sm-3 mx-2 mx-md-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="form_register2.php?load=SUBMIT" method="get">
                                    <div class="input-group my-3">
                                        <input type="text" class="form-control form-control-lg" name="ename" placeholder="ชื่อ นามสกุล สาขาวิชา">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        ...
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                                            <i class="fa-solid fa-user-plus"></i>&nbsp;เพิ่มข้อมูลอาจารย์ที่ปรึกศึกษาหรืออาจารย์ประสานงาน
                                        </button>&nbsp;
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="modal-title fs-3" id="exampleModalLabel">แบบฟอร์มข้อมูลอาจารย์ที่ปรึกศึกษาหรืออาจารย์ประสานงาน</div>
                                                ...
                                                <div class="container">
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <select class="form-select mt-3" name="prefix_tm" required>
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM tb_prefix"; // เรียกข้อมูล id_term และ term จากฐานข้อมูล
                                                            $result = mysqli_query($conn, $query);
                                                            while ($row = mysqli_fetch_assoc($result)) {
                                                                $id = $row['id'];
                                                                $nameprefix = $row['nameprefix'];
                                                                echo "<option value='$id'>$nameprefix</option>";
                                                            }
                                                            ?>
                                                        </select>
                                                        ...
                                                        <div class="row justify-content-star mb-3">
                                                            <div class="col-12 col-md-6 col-sm-12">
                                                                ...
                                                                <input class="form-control" name="firstname_tm" type="text" required>
                                                            </div>
                                                            <div class="col-12 col-md-6 col-sm-12">
                                                                <p class="text-start mt-3 fs-5">นามสกุล</p>
                                                                <input class="form-control" name="lastname_tm" type="text" required>
                                                            </div>
                                                        </div>

                                                        <p class="text-start mt-3 fs-5">เพศ</p>
                                                        <select class="form-select mt-3" name="gender_tm" required>
                                                            <option selected value="">-- เลือก --</option>
                                                        ...
                                                        <div class="row justify-content-star mb-3">
                                                            <div class="col-12 col-md-6 col-sm-12">
                                                                ...
                                                                <input class="form-control" name="faculty_tm" type="text" value="บริหารธุรกิจ" readonly required>
                                                            </div>
                                                            <div class="col-12 col-md-6 col-sm-12">
                                                                <p class="text-start mt-3 fs-5">สาขาวิชา</p>
                                                                <select class="form-select" name="branch_tm" required>
                                                                    <option selected value="">-- เลือก --</option>
                                                                    <?php
                                                                    $query = "SELECT * FROM tb_branch"; // เรียกข้อมูล id_term และ term จากฐานข้อมูล
                                                                    $result = mysqli_query($conn, $query);
                                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <select class="form-select my-3" name="status_tm" required>
                                                            <option selected value="">-- เลือก --</option>
                                                            <option value="2">อาจารย์ที่ปรึกษา</option>
                                                            <option value="4">อาจารย์ประสานงาน</option>
                                                        </select>

                                                        <span class="text-start fs-5">ระดับของสมาชิก</span>
                                                        <select class="form-select mt-3" name="userlevel_tm" required>
                                                            <option selected value="">-- เลือก --</option>
                                                            <option value="2">อาจารย์ที่ปรึกษา</option>
                                                            <option value="4">อาจารย์ประสานงาน</option>
                                                        </select>
                                                        ...
                                                        <input class="form-control" name="password_tm" id="passwordInput" type="password" minlength="5" maxlength="20" required>
                                                </div>
                                            </div>
