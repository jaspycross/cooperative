        ...
        if (!empty($_FILES['imge']['name'])) {
            ...
            Swal.fire( {
                ...
                showConfirmButton : false
                    ...
                    window.location.href = 'form_csv3.php';
                });
            });
        </script>";
                    } else {
                            ...
                            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                <div class="accordion-body">
                                    <ul class="list-group list-group-flush h6">
                                        ...
                                        <li class="list-group-item"><a href="form_csv3.php" class="text-decoration-none">เพิ่มข้อมูลพี่เลี้ยงนักศึกษาสหกิจ</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-3 mt-md-3 mt-sm-3 mx-2 mx-md-3">
                        <div class="card">
                            <div class="card-header">
                                <p class="text-center mt-3 fs-2">เพิ่มข้อมูลพี่เลี้ยงนักศึกษาสหกิจ</p>
                            ...
                            <div class="card-body">
                                ...
                                <form action="form_csv3.php?load=SUBMIT" method="get">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="container-fluid">
                                                                                ...
                                                                                <form action="" method="post" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <input type="hidden" value="<?php echo $row["id_m"]; ?>" name="id_m">
