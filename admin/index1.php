        ...
        <div class="container text-center ">
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-sm-12">
                                ...
                                <div class="card-body">
                                    <div class="container text-center">
                                        <div class="row row-cols-5">
                                            ...
                                            <div class="col-12 col-sm-4 mb-2">
                                                <a class="btn btn btn-primary w-100" href="index1.php" role="button"><i class="fa-solid fa-user"></i>&nbsp;นักศึกษาสหกิจ</a>
                                            </div>
                                            <div class="col-12 col-sm-4 mb-2">
                    ...
                    <!-- loop โฟสต์ข้อความ -->
                    <?php
                    $result = mysqli_query($conn, "SELECT * FROM `tb_postmessage` WHERE `headding` LIKE '1' ORDER BY `id` DESC");
                                ...
                                <div class="card-header ">
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            ...
                                            <a href="delmes1.php?delmes1=<?php echo $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')" title="ลบข้อมูล">
