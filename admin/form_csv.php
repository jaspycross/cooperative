                    ...
                    <div class="accordion accordion-flush border" id="accordionPanelsStayOpenExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                                <div class="accordion-body">
                                    <ul class="list-group list-group-flush h6">
                                        <li class="list-group-item"><a href="form_csv.php" class="text-decoration-none">เพิ่มข้อมูลนักศึกษาสหกิจ</a></li>
                    ...
                    <div class="mt-3 mt-md-3 mt-sm-3 mx-2 mx-md-3">
                        <div class="card">
                            <div class="card-header">
                                <p class="text-center mt-3 fs-2">เพิ่มข้อมูลนักศึกษาสหกิจ</p>
                            ...
                            <div class="card-body">
                                ...
                                <form action="form_csv.php?load=SUBMIT" method="get">
                                ...
                                <div class="table-responsive">
                                                ...
                                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- <a href="edit_csv.php?edituser=<?php echo $row['id']; ?>" type="button" class="fa-solid fa-pen-to-square btn btn-warning my-2 my-sm-2 my-lg-0 m-2" title="แก้ไขข้อมูล"></a> -->
                                                            <!-- <a href="del_csv.php?delcsv=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')" title="ลบข้อมูล">
                                    ...
                                    <?php } else {
                                                ...
                                                echo '<td class="fs-5" colspan="7">' . "ไม่มีข้อมูลลองค้นหาข้อมูลอีกครั้ง" . '</td>';
                                            } ?>
                                    </table>
                                </div>
                            </div>
