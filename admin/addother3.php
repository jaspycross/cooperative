...
if ($_SESSION['userlevel_tm'] != '5' || !$_SESSION['userlevel_tm']) {
    ...
    if (isset($_POST['btnsubmit'])) {
        ...
        $user_check = "SELECT nameprefix FROM tb_prefix WHERE nameprefix = '$nameprefix' LIMIT 1";
        ...
        if ($user) {
            ...
            $(document).ready(function() {
              Swal.fire( {
                title : 'คำนำหน้าซ้ำไม่สามารถบันทึกได้',
                icon : 'info'
                }).then(function() {
                    window.location.href = 'addother3.php';
                });
              });
            </script>";
        } else {

            $query  = "INSERT INTO tb_prefix (nameprefix) VALUES ('$nameprefix')";
    ...
    if (isset($_POST['btnedit'])) {
        ...
        $user_check = "SELECT * FROM tb_prefix WHERE nameprefix = '$nameprefix' LIMIT 1";
        $result = mysqli_query($conn, $user_check);
        $user = mysqli_fetch_assoc($result);
        ...
        if ($user) {
            ...
            $query  = "UPDATE tb_prefix SET nameprefix='$nameprefix' WHERE id=$id";
            $result = mysqli_query($conn, $query);
            ...
            <div class="row justify-content-start">
                <div class="col-12 col-md-3 col-sm-12 mb-0 mb-md-0 mb-sm-3 g-0">
                    <div class="accordion accordion-flush border" id="accordionPanelsStayOpenExample">
                        ...
                        <a class="btn w-100 p-3 text-start border-bottom rounded-0 text-primary" href="addother3.php" role="button"><i class="fa-regular fa-address-card"></i>&nbsp;เพิ่มคำนำหน้าชื่อ</a>
                    ...
                    <div class="mt-3 mt-md-3 mt-sm-3 mx-2 mx-md-3">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalTitleId">คำนำหน้าชื่อ</h5>
                                                ...
                                                <div class="container-fluid">
                                                    <form action="" method="post">
                                                        <div class="form-floating my-3">
                                                            <input type="text" class="form-control" placeholder=" " name="nameprefix" id="floatingInput" required>
                                                            <label for="floatingInput">คำนำหน้าชื่อ</label>
                                                        </div>
                                                </div>
                                            </div>
                                ...
                                <?php $query = "SELECT * FROM tb_prefix"; // เรียกข้อมูล id_term และ term จากฐานข้อมูล
                                $result = mysqli_query($conn, $query);
                                ?>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- Button trigger modal -->
                                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalId1<?php echo $row['id']; ?>">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </button>

                                                            <!-- Modal -->
                                                            <div class="modal fade" id="modalId1<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="modalTitleId">แก้ไขคำนำหน้า</h5>
                                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <div class="container-fluid">
                                                                                <form action="" method="post">
                                                                                    ...
                                                                                    <div class="form-floating my-3">
                                                                                        <input type="text" class="form-control" name="nameprefix" placeholder=" " value="<?php echo $row['nameprefix']; ?>" id="floatingInput" required>
                                                            ...
                                                            <a href="del_addother3.php?del=<?php echo $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')" title="ลบ"><i class="fa-solid fa-trash-can" name="del"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $i++;
