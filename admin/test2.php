...
if ($_SESSION['userlevel_tm'] != '5' || !$_SESSION['userlevel_tm']) {
    ...
    if (isset($_POST['btnsubmit'])) {
        ...
        $sql = "INSERT INTO tb_place( company_name, orgorcom, address, provinces, amphures, districts, zip_code, imge, url)
          VALUE ('$company_name', '$orgorcom', '$address', '$provinces', '$amphures', '$districts', '$zip_code', '$newfilename', '$url')";
    ...
    if (isset($_POST['btnupdate'])) {
        ...
        $sql = "UPDATE tb_place set company_name = '$company_name',
        orgorcom = '$orgorcom',
    address = '$address',
    provinces = '$provinces',
    amphures = '$amphures',
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row justify-content-center align-items-center g-2">
                                                            ...
                                                            <div class="col-12 col-md-6 col-sm-12">
                                                                ...
                                                                <p><?php echo $row['amphures']; ?></p>
                                                                <p><?php echo $row['provinces']; ?></p>
                                                                <p><?php echo $row['districts']; ?></p>
