                ...
                <div class="card my-5">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                                <a class="nav-link " href="recover_psw.php">นักศึกษาสหกิจ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="true" href="recover_psw1.php">อาจารย์ที่ปรึกษาหรืออาจารย์ประสานงาน</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="email" id="email_address" class="form-control" name="email_tm" required autofocus>
                                </div>
                            </div>
...
if (isset($_POST["recover"])) {
    ...
    $email = $_POST["email_tm"];

    $sql = mysqli_query($conn, "SELECT * FROM tb_teacher_admin WHERE email_tm = '$email'");
...
?>
        ...
        echo "<script>
            ...
            Swal.fire( {
                ...
                window.location.href = 'recover_psw1.php';
            });
        });
        </script>";
        ?>
    <?php
    } else if ($fetch["userlevel_tm"] != 5 && $fetch["userlevel_tm"] != 4 && $fetch["userlevel_tm"] != 2) {
    ?>
        <?php
        echo "<script>
            $(document).ready(function() {
        ...
        $mail->addAddress($_POST["email_tm"]);
        ...
        $mail->Body = "
            ...
            http://localhost/project1/reset_psw1.php";
